...
func _ready():
	...
	targetCol_cir = get_node("UI/TargetColor_circle")
	currentCol_cir = get_node("UI/CurrentColor_circle")
	targetCol_cir.set_color(TargetColor)
	currentCol_cir.reset_color()
	
	# set UI CurrentColor_label and TargetColor_label
	targetCol_label = get_node("UI/TargetColor_RGB")
	currentCol_label = get_node("UI/CurrentColor_RGB")
